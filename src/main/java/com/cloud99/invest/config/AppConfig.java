...
@ComponentScan(basePackages = { "com.cloud99.invest" },
		excludeFilters = @ComponentScan.Filter(type = FilterType.REGEX, pattern = "com.cloud99.config.*"))
@PropertySource("classpath:application-${spring.profiles.active}.properties")
@EnableWebMvc
@Order(1)
public class AppConfig extends WebMvcAutoConfiguration implements WebMvcConfigurer {

	public static final SimpleDateFormat UTC_DATE_FORMAT = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS");
